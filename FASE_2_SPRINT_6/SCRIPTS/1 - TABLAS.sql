...
ALTER TABLE [dbo].[AUX_ACTUALIZAGARANTIAS] ADD Monto_Ultima_Tasacion_Terreno DECIMAL(22, 2) NULL
GO

ALTER TABLE [dbo].[AUX_ACTUALIZAGARANTIAS] ADD Monto_Ultima_Tasacion_No_Terreno DECIMAL(22, 2) NULL
GO
