...
{
    public class TiposIdentificacionesRUCEntidad
    {
        ...
        private string _codTipoIdentificacionRUC;
        public string CodTipoIdentificacionRUC
        {
            get
            {
                return _codTipoIdentificacionRUC;
            }
            set
            {
                _codTipoIdentificacionRUC = value;
            }
        }
