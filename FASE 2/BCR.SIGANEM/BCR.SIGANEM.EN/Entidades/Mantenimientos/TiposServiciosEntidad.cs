...
{
    public class TiposServiciosEntidad
    {
        ...
        private string _tipoServicioTasador;
        public string TipoServicioTasador
        {
            get
            {
                return _tipoServicioTasador;
            }
            set
            {
                _tipoServicioTasador = value;
            }
        }
