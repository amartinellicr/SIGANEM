...
{
    public class ZonasTasadoresEntidad
    {
        ...
        private string _codTipoZonaTasador;
        public string CodTipoZonaTasador
        {
            get
            {
                return _codTipoZonaTasador;
            }
            set
            {
                _codTipoZonaTasador = value;
            }
        }
