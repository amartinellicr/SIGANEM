...
{
    public class TiposAvalesFianzasEntidad
    {
        ...
        private string _codTipoAvalFianza;
        public string CodTipoAvalFianza
        {
            get
            {
                return _codTipoAvalFianza;
            }
            set
            {
                _codTipoAvalFianza = value;
            }
        }
