...
public partial class Fideicomisos : System.Web.UI.Page
{
    ...
    private GarantiasWS.GarantiasFideicomisosEntidad garantiasFideicomisosEntidad = new GarantiasWS.GarantiasFideicomisosEntidad();
        ...
        try
        {
            ...
            if (AccesoPermisoPagina())
            {
                ...
                if (!Page.IsPostBack)
                {
                    ...
                    consultaEntidad.ColumnaFiltro = "Id_Fideicomiso_BCR"; /*Cambio F02S02*/
                    consultaEntidad.ColumnaOrdenar = "Id_Fideicomiso_BCR"; /*Cambio F02S02*/
                ...
                // ASIGNA DATA KEYS
                String[] dataKeysString = { "IdGarantiaFideicomiso" }; /*Cambio F02S02*/
    ...
    private void gridView_Init(object sender, EventArgs e)
    {
        ...
        gvTemplate.CrearCamposGridNoVisibles(gridView, "IdGarantiaFideicomiso", lblID); /*Cambio F02S02*/

        this.gridViewColumna = new GridViewColumn(); 
        //this.gridView.Columns.Add(this.gridViewColumna.CreateBoundField("DesFideicomiso", string.Empty, "Id Fideicomiso", HorizontalAlign.Center, false, true)); /*Cambio F02S02*/
        //this.gridView.Columns.Add(this.gridViewColumna.CreateBoundField("CodFideicomiso", string.Empty, "Id Fideicomiso", HorizontalAlign.Center, false, true)); /*Cambio F02S02*/
        this.gridView.Columns.Add(this.gridViewColumna.CreateBoundField("CodFideicomiso", string.Empty, "Id Fideicomiso", HorizontalAlign.Center, false, true)); /*Cambio F02S02*/


        this.gridViewColumna = new GridViewColumn();
        this.gridView.Columns.Add(this.gridViewColumna.CreateBoundField("CodFidecomisoBCR", string.Empty, "Id Fideicomiso BCR", HorizontalAlign.Center, false, true)); /*Cambio F02S02*/

        this.gridViewColumna = new GridViewColumn();
        this.gridView.Columns.Add(this.gridViewColumna.CreateBoundField("ValorNominal", string.Empty, "Valor Nominal", HorizontalAlign.Center, false, true)); /*Cambio F02S02*/

        this.gridViewColumna = new GridViewColumn();
        this.gridView.Columns.Add(this.gridViewColumna.CreateBoundField("DesFechaVencimiento", string.Empty, "Fecha Vencimiento", HorizontalAlign.Center, false, true)); /*Cambio F02S02*/
    ...
    private void CargarDDLFiltro()
    {
        ...
        //this.ddlFiltro.Items.Add(new ListItem("Id Fideicomiso", "Cod_Fideicomiso")); 
        this.ddlFiltro.Items.Add(new ListItem("Id Fideicomiso BCR", "Id_Fideicomiso_BCR")); 
        this.ddlFiltro.Items.Add(new ListItem("Id Fideicomiso", "Cod_Fideicomiso"));   
        this.ddlFiltro.Items.Add(new ListItem("Valor Nominal", "Valor_Nominal")); 
        this.ddlFiltro.Items.Add(new ListItem("Fecha Vencimiento", "Des_Fecha_Vencimiento")); 
        ...
        try
        {
            ...
            if (sesion.Codigo == 0)
            {
                if (Page.IsPostBack)
                {
                    ...
                    post.RedirectAndPOSTNewBigWindow(this.Page, "../Detalles/FideicomisosNew.aspx", SetRutaVentana()); /*Cambio F02S02*/
                }
            }
        }
        catch (Exception ex)
                ...
                if (Page.IsPostBack)
                {
                    if (ContadorSeleccionados() < 2) //SI SOLO EXISTE UN REGISTRO SELECCIONADO
                    {
                        foreach (GridViewRow row in gridView.Rows)
                        {
                            ...
                            {
                                Label lbl = (Label)gridView.Rows[row.RowIndex].FindControl("lblIdGarantiaFideicomiso"); /*Cambio F02S02*/
            ...
            if (sesion.Codigo == 0)
            {
                ...
                foreach (GridViewRow row in gridView.Rows)
                {
                    ...
                    if (checkBoxColumn.Checked)
                    {
                        ...
                        pantallaIdOculto.Value = lbl.Text;
                        garantiasFideicomisosEntidad.IdGarantiaFideicomiso = int.Parse(lbl.Text); /*Cambio F02S02*/
                        //REQUERIMIENTO: 1-24381561
                        garantiasFideicomisosEntidad.CodUsuarioIngreso = codUsuarioOculto.Value; /*Cambio F02S02*/

                        #endregion
                        resultado = this.Eliminar(garantiasFideicomisosEntidad); /*Cambio F02S02*/
                ...
                switch (e.CommandName)
                {
                    case "Next":
                        ...
                        if (Int32.Parse(this.txtSlide.Text) <= this.Registros)
                        {
                            ...
                            consultaEntidad.ColumnaOrdenar = "Id_Fideicomiso_BCR";
    ...
    private GarantiasWS.RespuestaEntidad Eliminar(GarantiasWS.GarantiasFideicomisosEntidad _entidad)
    {
        //Retornar Consulta Vacía
        //return null;
        return wsGarantias.GarantiasFideicomisosEliminar(_entidad, AsignarValoresBitacora(EnumTipoBitacora.ELIMINAR));
    }
    ...
    private Int32 TotalFilas(GarantiasWS.ParametrosTotalFilasEntidad _entidad)
    {
        //Retornar Consulta Vacía
        //return 0;
        return wsGarantias.GarantiasFideicomisosTotalFilas(_entidad);
    }


    private List<GarantiasFideicomisosEntidad> Consulta(GarantiasWS.ParametrosConsultaEntidad _entidad)
    {
        //Retornar Lista Vacía
        //return new List<GarantiasAvalesEntidad>();
        return (wsGarantias.GarantiasFideicomisosConsultar(_entidad)).ToList();
    }
    ...
    private void BindGridView(GridView _gridView, List<GarantiasFideicomisosEntidad> _lista)
    {
    ...
    protected virtual void Dispose(bool disposing)
    {
        if (!disponible)
        {
            ...
            garantiasFideicomisosEntidad = null;
