<%@ Page Language="C#" MasterPageFile="~/Library/styles/MasterPages/Main.Master" AutoEventWireup="true" CodeFile="InscripcionReales.aspx.cs" Inherits="InscripcionReales" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">
    <title>Inscripción Garantías Reales</title> 
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <input type="hidden" id="idGarantiaRealOculto" clientidmode="Static" runat="server" />
