...
public partial class DistribucionZonasTasadoresExternos : System.Web.UI.Page
{
    ...
    private ConsultasWS.DistribucionesZonasTasadoresEntidad _distribucionZonasTasadoresEntidad = new ConsultasWS.DistribucionesZonasTasadoresEntidad();
        ...
        try
        {
            ...
            if (AccesoPermisoPagina())//CAMBIAR SESION-AGREGAR
            {
                ...
                if (!Page.IsPostBack)
                {
                    ...
                    _consultaEntidad.ColumnaFiltro = "Cod_Tipo_Distribucion_Zona_Tasador";
                    _consultaEntidad.ColumnaOrdenar = "Cod_Tipo_Distribucion_Zona_Tasador";
    ...
    private void gridView_Init(object sender, EventArgs e)
    {
        ...
        _gvTemplate.CrearCamposGridNoVisibles(gridView, "IdDistribucionZonaTasador", lblID);

        this.gridViewColumna = new GridViewColumn();
        this.gridView.Columns.Add(this.gridViewColumna.CreateBoundField("CodZonaTasador", string.Empty, "Zona", HorizontalAlign.Center, false, true));
    ...
    private void CargarDDLFiltro()
    {
        ...
        this.ddlFiltro.Items.Add(new ListItem("Zona", "Cod_Zona_Tasador"));
            ...
            if (sesion.Codigo == 0)
            {
                ...
                foreach (GridViewRow row in gridView.Rows)
                {
                    ...
                    if (checkBoxColumn.Checked)
                    {
                        ...
                        pantallaIdOculto.Value = lbl.Text;
                        _distribucionZonasTasadoresEntidad.IdDistribucionZonaTasador = int.Parse(lbl.Text);

                        #endregion

                        _result = this.Eliminar(_distribucionZonasTasadoresEntidad);
                    }
                }
    ...
    private ConsultasWS.RespuestaEntidad Eliminar(DistribucionesZonasTasadoresEntidad _entidad)
    {
        _entidad.CodTipoDistribucionZonaTasador = "X";
        return wsConsultas.DistribucionZonasTasadoresEliminar(_entidad, AsignarValoresBitacora(EnumTipoBitacora.ELIMINAR));
    }

    private Int32 TotalFilas(ConsultasWS.ParametrosTotalFilasEntidad _entidad)
    {
        return wsConsultas.DistribucionZonasTasadoresTotalFilas(_entidad, "X");
    }

    private List<DistribucionesZonasTasadoresEntidad> Consulta(ConsultasWS.ParametrosConsultaEntidad _entidad)
    {
        return wsConsultas.DistribucionZonasTasadoresConsultar(_entidad, "X").ToList();
    }
    ...
    private void BindGridView(GridView _gridView, List<DistribucionesZonasTasadoresEntidad> _lista)
    {
    ...
    protected virtual void Dispose(bool disposing)
    {
        if (!_disposed)
        {
            ...
            _distribucionZonasTasadoresEntidad = null;
