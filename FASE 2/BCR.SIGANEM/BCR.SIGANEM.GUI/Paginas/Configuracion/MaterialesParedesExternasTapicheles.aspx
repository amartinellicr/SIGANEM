<%@ Page Language="C#" Title="Material Paredes Externas y Tapicheles" MasterPageFile="~/Library/styles/MasterPages/Main.Master" AutoEventWireup="true" CodeFile="MaterialesParedesExternasTapicheles.aspx.cs" Inherits="MaterialesParedesExternasTapicheles" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">
    <title>Material Paredes Externas y Tapicheles</title>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder2" Runat="Server">
    <asp:UpdatePanel ID="updMasterPager" UpdateMode="Conditional" runat="server">
        <ContentTemplate>
