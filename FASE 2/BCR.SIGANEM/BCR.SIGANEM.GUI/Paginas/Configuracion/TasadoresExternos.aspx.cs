...
public partial class TasadoresExternos : System.Web.UI.Page
{
    ...
    {
        return wsConsultas.TasadoresTotalFilas(entidad);
    }

    private List<TasadoresEntidad> Consulta(ConsultasWS.ParametrosConsultaEntidad entidad)
    {
        return wsConsultas.TasadoresConsultar(entidad).ToList();
    }
