...
public partial class OficinasTasadoresInternos : System.Web.UI.Page
{
    ...
    private void gridView_Init(object sender, EventArgs e)
    {
        ...
        _gvTemplate.CrearCamposGridNoVisibles(gridView, "IdZonaTasador", lblID);

        this.gridViewColumn = new GridViewColumn();
        this.gridView.Columns.Add(this.gridViewColumn.CreateBoundField("CodZonaTasador", string.Empty, "Oficina", HorizontalAlign.Center, false, true));
    }
            ...
            if (sesion.Codigo == 0)
            {
                ...
                foreach (GridViewRow row in gridView.Rows)
                {
                    ...
                    if (checkBoxColumn.Checked)
                    {
                        ...
                        _result = this.Eliminar(zonasTasadoresEntidad);
                    }
                }
    ...
    {
        return wsConsultas.ZonasTasadoresTotalFilas(_entidad, "I");
    }

    private List<ZonasTasadoresEntidad> Consulta(ConsultasWS.ParametrosConsultaEntidad _entidad)
    {
        return wsConsultas.ZonasTasadoresConsultar(_entidad, "I").ToList();
    }
