<%@ Page Title="Bitácora de Proceso" Language="C#" MasterPageFile="~/Library/styles/MasterPages/Main.Master"
    AutoEventWireup="true" CodeFile="BitacoraProcesos.aspx.cs" Inherits="BitacoraProcesos" %>
                        ...
                        <div style="left: 3px; bottom: 3px; background-color: white; width: 99.5%; position: relative">
                            <div style="width: 740px; position: relative">
                                ...
                                <div style="text-align: center">
                                    <asp:Button ID="btnGenerar" runat="server" ClientIDMode="Static" Text="Consultar"
                                        OnClick="btnGenerar_Click" CssClass="mainTableBoxesCss" />
                                </div>
                                <br />
                            </div>
                        </div>
