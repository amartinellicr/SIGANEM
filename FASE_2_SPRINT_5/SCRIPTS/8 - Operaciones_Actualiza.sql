...
IF OBJECT_ID ('Operaciones_Actualiza', 'P') IS NOT NULL
	DROP PROCEDURE dbo.Operaciones_Actualiza;
GO
...
AS 
/******************************************************************************************************************************************************
<Nombre>Operaciones_Actualiza</Nombre>
<Sistema>N.A.</Sistema>
...
BEGIN 
       ...
       DECLARE	@cbEstado_Registro_Operacion VARCHAR(1)
       SET	@cbEstado_Registro_Operacion = 1
