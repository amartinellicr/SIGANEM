<%@ page language="C#" autoeventwireup="true" inherits="Login, App_Web_nt54kkk0" %>
                    ...
                    <table style="width: 100%">
                        ...
                        <tr>
                            <td class="LoginCredential">
                                <asp:TextBox ID="txtUsuario" runat="server" AutoCompleteType="Disabled" CssClass="LoginTextbox" Width="100%" Height="22px" MaxLength="20" TabIndex="1"></asp:TextBox>
                        ...
                        <tr>
                            <td class="LoginCredential">
                                <asp:TextBox ID="txtContrasena" runat="server" AutoCompleteType="Disabled" CssClass="LoginTextbox" Width="100%" TabIndex="2" Height="22px" MaxLength="255" TextMode="Password"
